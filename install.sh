...
#create "manual" table
sudo mysql -uroot -p$PASSWORD "CREATE TABLE IF NOT EXISTS `pins`.`manual` ( `id` int(11) NOT NULL AUTO_INCREMENT, `mode` varchar(20) NOT NULL, `end_time` time NOT NULL, `relay` int(11) NOT NULL, `notes` varchar(255), PRIMARY_KEY(`id`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;" || (echo "Create 'manual' table Failed. Aborting..." && exit 1) 
